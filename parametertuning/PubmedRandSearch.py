...
def HypeParameterSpace(data_name):
    learning_rate = {'name': 'learning_rate', 'type': 'range', 'bounds': [0.0001, 0.001], "log_scale": True}
    ...
    top_k = {'name': 'top_k', 'type': 'choice', 'values': [3, 5, 7, 9]}
...
if __name__ == '__main__':
    generate_random_search_bash(data_name='pubmed', task_num=100)